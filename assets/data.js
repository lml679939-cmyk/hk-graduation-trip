...
const ITINERARY = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        time: "12:00–13:00",
        act: "搭車前往淺水灣（12:00 旺角站集合）",
        note: "step① 地鐵：旺角站 → 荃灣線（往金鐘）→ 金鐘站<br>step② 公車：金鐘站 B 出口 → 金鐘站（西座）巴士總站 → <b>城巴 260</b>（往赤柱村方向，最快）/ 城巴 6 / 6X / 綠色小巴 40 / 40X → 淺水灣海灘站"
      },
      {
        time: "13:00",
...
const RESTAURANTS = [
  ...
  {
    name: "Hashtag B 蛋塔", cap: "no", days: [1],
  ...
  {
    name: "標記樂園潮州粉麵菜館", cap: "yes", days: [1],
    addr: "🚇 旺角站（E2 出口 4 分鐘）\n香港旺角通菜街 12–14 號",
  ...
  {
    name: "Caffè Parabolica", cap: "yes", days: [3],
